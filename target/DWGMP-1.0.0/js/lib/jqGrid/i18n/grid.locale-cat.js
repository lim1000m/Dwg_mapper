 ...
 * Traducci처 jqGrid en Catat횪 per Faserline, S.L.
...
$.extend($.jgrid,{
	...
	edit : {
		...
		msg: {
		    ...
		    email: "no 챕s una direcci처 de correu v횪lida",
		    integer: "Introdueixi un valor enter",
			date: "Introdueixi una data correcta ",
			url: "no 챕s una URL v횪lida. Prefix requerit ('http://' or 'https://')",
	...
	del : {
		caption: "Eliminar",
		msg: "쩔Desitja eliminar els registres seleccionats?",
		bSubmit: "Eliminar",
		bCancel: "Cancelar"
	},
	nav : {
...
// setcolumns module
	...
	errors : {
		...
		model : "Les columnes de noms s처n diferents de les columnes del model"
	},
	formatter : {
		...
		date : {
			...
			monthNames: [
				"Gen", "Febr", "Mar챌", "Abr", "Maig", "Juny", "Jul", "Ag", "Set", "Oct", "Nov", "Des",
