...
$.extend($.jgrid,{
	...
	search : {
	    ...
	    Find: "Bul",
	    Reset: "Temizle",	    
	    odata: [{ oper:'eq', text:"e힊it"},{ oper:'ne', text:"e힊it de휓il"},{ oper:'lt', text:"daha az"},{ oper:'le', text:"daha az veya e힊it"},{ oper:'gt', text:"daha fazla"},{ oper:'ge', text:"daha fazla veya e힊it"},{ oper:'bw', text:"ile ba힊layan"},{ oper:'bn', text:"ile ba힊lamayan"},{ oper:'in', text:"i챌inde"},{ oper:'ni', text:"i챌inde de휓il"},{ oper:'ew', text:"ile biten"},{ oper:'en', text:"ile bitmeyen"},{ oper:'cn', text:"i챌eren"},{ oper:'nc', text:"i챌ermeyen"}],
