...
$.extend($.jgrid,{
	...
	edit : {
		...
		msg: {
			...
			minValue:"Vrijednost mora biti ve훶a ili identi훾na ",
			maxValue:"Vrijednost mora biti manja ili identi훾na",
	...
	del : {
		caption: "Obri큄i",
		msg: "Obri큄i ozna훾en zapis ili vi큄e njih?",
		bSubmit: "Obri큄i",
		bCancel: "Odustani"
	},
	nav : {
		edittext: " ",
		edittitle: "Promijeni obilje탑eni red",
		addtext:" ",
		addtitle: "Dodaj novi red",
		deltext: " ",
		deltitle: "Obri큄i obilje탑eni red",
		searchtext: " ",
		searchtitle: "Potra탑i zapise",
		refreshtext: "",
		refreshtitle: "Ponovo preuzmi podatke",
		alertcap: "Upozorenje",
		alerttext: "Molim, odaberi red",
		viewtext: "",
		viewtitle: "Pregled obilje탑enog reda"
	},
	col : {
		caption: "Obilje탑i kolonu",
		bSubmit: "Uredu",
		bCancel: "Odustani"
	},
	errors : {
		...
		model : "colNames i colModel imaju razli훾itu duljinu!"
	},
	formatter : {
		...
		date : {
			dayNames:   [
				...
				"Nedjelja", "Ponedjeljak", "Utorak", "Srijeda", "훻etvrtak", "Petak", "Subota"
			],
			monthNames: [
				"Sij", "Vel", "O탑u", "Tra", "Svi", "Lip", "Srp", "Kol", "Ruj", "Lis", "Stu", "Pro",
