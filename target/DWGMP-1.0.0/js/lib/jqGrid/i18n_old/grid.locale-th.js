...
$.jgrid = {
	...
	search : {
		...
		odata : ['仙錫쀠퉰錫꿋툈錫긍툣', '仙꾝륫仙댽?錫쀠퉰錫꿋툈錫긍툣', '錫쇸퉱錫?륭錫곟름仙댽림', '仙꾝륫仙댽륫錫꿋툈錫곟름仙댽림','錫□림錫곟툈錫곟름仙댽림','仙꾝륫仙댽툢仙됢릎錫№툈錫㏅퉰錫?, '錫귖마仙됢툢錫뺖퉱錫쇸툝仙됢름錫?,'仙꾝륫仙댽툊錫뜩퉱錫쇸툞仙됢툢錫붲퉱錫㏅륭','錫□링錫꾝립仙꺺툝錫꾝립錫ム툢錫뜩퉰錫뉋퉫錫?,'仙꾝륫仙댽륫錫듀툌錫녀퉫錫붲툌錫녀릊錫쇸마仙댽툏仙꺺툢','錫?툏錫쀠퉱錫꿋륭錫붲퉱錫㏅륭','仙꾝륫仙댽른錫뉋툠仙됢림錫№툝仙됢름錫?,'錫□링錫꾝립錫㏅퉰錫?,'仙꾝륫仙댽륫錫듀툌錫녀름仙댽림'],
		groupOps: [	{ op: "仙곟른錫?, text: "錫쀠릴仙됢툏錫ム륫錫? },	{ op: "錫ム르錫룅릎",  text: "仙꺺툝仙? }	],
		matchText: " 錫뺖르錫뉋툈錫긍툢錫곟릴錫?,
		rulesText: " 錫뺖림錫□툈錫?
	},
	edit : {
