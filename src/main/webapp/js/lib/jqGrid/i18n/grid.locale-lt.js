...
$.extend($.jgrid,{
	...
	search : {
		...
		Find: "Ie큄koti",
		Reset: "Atstatyti",
		odata: [{ oper:'eq', text:"lygu"},{ oper:'ne', text:"nelygu"},{ oper:'lt', text:"ma탑iau"},{ oper:'le', text:"ma탑iau arba lygu"},{ oper:'gt', text:"daugiau"},{ oper:'ge', text:"daugiau arba lygu"},{ oper:'bw', text:"prasideda"},{ oper:'bn', text:"neprasideda"},{ oper:'in', text:"reik큄m휊 yra"},{ oper:'ni', text:"reik큄m휊s n휊ra"},{ oper:'ew', text:"baigiasi"},{ oper:'en', text:"nesibaigia"},{ oper:'cn', text:"yra sudarytas"},{ oper:'nc', text:"n휊ra sudarytas"}],
