...
$.jgrid = {
	...
	edit : {
	    ...
	    msg: {
			...
			date: "Indtast venligst en valid datov챈rdi",
	...
	del : {
	    caption: "Slet",
	    msg: "Slet valgte r챈kke(r)?",
	    bSubmit: "Slet",
	    bCancel: "Annuller"
	},
	nav : {
		edittext: " ",
	    edittitle: "Rediger valgte r챈kke",
		addtext:" ",
	    addtitle: "Tilf첩j ny r챈kke",
	    deltext: " ",
	    deltitle: "Slet valgte r챈kke",
	    searchtext: " ",
	    searchtitle: "Find poster",
	    refreshtext: "",
	    refreshtitle: "Indl챈s igen",
	    alertcap: "Advarsel",
	    alerttext: "V챈lg venligst r챈kke",
		viewtext: "",
