...
$.extend($.jgrid,{
	...
	search : {
		...
		Find: "Chercher",
		Reset: "R챕initialiser",
		odata: [{ oper:'eq', text:"챕gal"},{ oper:'ne', text:"diff챕rent"},{ oper:'lt', text:"inf챕rieur"},{ oper:'le', text:"inf챕rieur ou 챕gal"},{ oper:'gt', text:"sup챕rieur"},{ oper:'ge', text:"sup챕rieur ou 챕gal"},{ oper:'bw', text:"commence par"},{ oper:'bn', text:"ne commence pas par"},{ oper:'in', text:"est dans"},{ oper:'ni', text:"n'est pas dans"},{ oper:'ew', text:"finit par"},{ oper:'en', text:"ne finit pas par"},{ oper:'cn', text:"contient"},{ oper:'nc', text:"ne contient pas"}],
