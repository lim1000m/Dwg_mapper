...
* Tradu占쏙옙o da jqGrid em Portugues por Frederico Carvalho, http://www.eyeviewdesign.pt
...
$.extend($.jgrid,{
	...
	edit : {
	    ...
	    msg: {
	        ...
	        email: "N占퐋 占?um endere占퐋 de email v占퐇ido",
	...
	errors : {
		errcap : "Erro",
		nourl : "N占퐋 especificou um url",
		norecords: "N占퐋 existem dados para processar",
	...
	formatter : {
		...
		date : {
			dayNames:   [
				...
				"Domingo", "Segunda-Feira", "Ter占폸-Feira", "Quarta-Feira", "Quinta-Feira", "Sexta-Feira", "S占폹ado"
			],
			monthNames: [
				"Jan", "Fev", "Mar", "Abr", "Mai", "Jun", "Jul", "Ago", "Set", "Out", "Nov", "Dez",
				"Janeiro", "Fevereiro", "Mar占퐋", "Abril", "Maio", "Junho", "Julho", "Agosto", "Setembro", "Outubro", "Novembro", "Dezembro"
			],
			AmPm : ["am","pm","AM","PM"],
			S: function (j) {return j < 11 || j > 13 ? ['占?, '占?, '占?, '占?][Math.min((j - 1) % 10, 3)] : '占?},
			srcformat: 'Y-m-d',
			newformat: 'd/m/Y',
			parseRe : /[Tt\\\/:_;.,\t\s-]/,
			masks : {
