...
$.jgrid = {
	...
	search : {
		...
		odata : ['lika', 'ej lika', 'mindre', 'mindre eller lika','st철rre','st철rre eller lika', 'b철rjar med','b철rjar inte med','tillh철r','tillh철r inte','slutar med','slutar inte med','inneh책ller','inneh책ller inte'],
