...
* Tradu豫o da jqGrid em Portugues por Frederico Carvalho, http://www.eyeviewdesign.pt
...
$.jgrid = {
	...
	edit : {
	    ...
	    msg: {
	        ...
	        email: "N? ?um endere? de email v?ido",
	...
	errors : {
		errcap : "Erro",
		nourl : "N? especificou um url",
		norecords: "N? existem dados para processar",
	...
	formatter : {
		...
		date : {
			dayNames:   [
				...
				"Domingo", "Segunda-Feira", "Ter?-Feira", "Quarta-Feira", "Quinta-Feira", "Sexta-Feira", "S?ado"
			],
			monthNames: [
