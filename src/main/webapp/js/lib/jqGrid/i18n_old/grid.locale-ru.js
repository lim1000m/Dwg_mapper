...
$.jgrid = {
    ...
    Find: "?逵橘?龜",
    Reset: "鬼閨?棘?",
    odata : ['?逵勻戟棘', '戟筠 ?逵勻戟棘', '劇筠戟??筠', '劇筠戟??筠 龜剋龜 ?逵勻戟棘','閨棘剋??筠','閨棘剋??筠 龜剋龜 ?逵勻戟棘', '戟逵?龜戟逵筠??? ?','戟筠 戟逵?龜戟逵筠??? ?','戟逵?棘畇龜??? 勻','戟筠 戟逵?棘畇龜??? 勻','鈞逵克逵戟?龜勻逵筠??? 戟逵','戟筠 鈞逵克逵戟?龜勻逵筠??? 戟逵','?棘畇筠?菌龜?','戟筠 ?棘畇筠?菌龜?'],
    ...
    bCancel: "??劇筠戟逵",
        ...
        url: "戟筠勻筠?戟逵? ???剋克逵. ?筠棘閨?棘畇龜劇棘 勻勻筠??龜 極?筠?龜克? ('http://' or 'https://')",
