/* ------------------------------------------------------------------------
 * Class: freezeHeaderUse:freeze header row in html tableExample 1:  $('#tableid').freezeHeader();
 * Example 2:  $("#tableid").freezeHeader({ 'height': '300px' });Example 3:  $("table").freezeHeader();
 * Example 4:  $(".table2").freezeHeader();Author: Laerte Mercier JuniorVersion: 1.0.5
 * -------------------------------------------------------------------------*/
