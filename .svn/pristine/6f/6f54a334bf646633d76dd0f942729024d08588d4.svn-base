...
$.jgrid = {
	...
	search : {
	    ...
	    Find: "Find",
	    Reset: "Nulstil",
	    odata : ['lig', 'forskellige fra', 'mindre', 'mindre eller lig','st첩rre','st첩rre eller lig', 'begynder med','begynder ikke med','findes i','findes ikke i','ender med','ender ikke med','indeholder','indeholder ikke'],
