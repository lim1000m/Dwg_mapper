...
$.jgrid = {
	...
	search : {
		...
		Find: "Caut훱",
		Reset: "Resetare",
		odata : ['egal', 'diferit', 'mai mic', 'mai mic sau egal','mai mare','mai mare sau egal', '챤ncepe cu','nu 챤ncepe cu','se g훱se?te 챤n','nu se g훱se?te 챤n','se termin훱 cu','nu se termin훱 cu','con?ine',''],
