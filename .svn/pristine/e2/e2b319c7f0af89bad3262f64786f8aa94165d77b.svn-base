...
$.extend($.jgrid,{
    ...
    Find: "?戟逵橘?龜",
    Reset: "鬼克龜畇逵戟戟?",
    odata: [{ oper:'eq', text:"??勻戟棘"},{ oper:'ne', text:"戟筠 ??勻戟棘"},{ oper:'lt', text:"劇筠戟?筠"},{ oper:'le', text:"劇筠戟?筠 逵閨棘 ??勻戟筠"},{ oper:'gt', text:"閨?剋??筠"},{ oper:'ge', text:"閨?剋??筠 逵閨棘 ??勻戟筠"},{ oper:'bw', text:"極棘?龜戟逵????? 鈞"},{ oper:'bn', text:"戟筠 極棘?龜戟逵????? 鈞"},{ oper:'in', text:"鈞戟逵?棘畇龜???? 勻"},{ oper:'ni', text:"戟筠 鈞戟逵?棘畇龜???? 勻"},{ oper:'ew', text:"鈞逵克?戟??????? 戟逵"},{ oper:'en', text:"戟筠 鈞逵克?戟??????? 戟逵"},{ oper:'cn', text:"劇???龜??"},{ oper:'nc', text:"戟筠 劇???龜??"}],
