...
$.extend($.jgrid,{
	...
	search : {
		...
		Find: "Hledat",
		Reset: "Reset",
	    odata: [{ oper:'eq', text:"rovno"},{ oper:'ne', text:"nerovono"},{ oper:'lt', text:"men큄챠"},{ oper:'le', text:"men큄챠 nebo rovno"},{ oper:'gt', text:"v휎t큄챠"},{ oper:'ge', text:"v휎t큄챠 nebo rovno"},{ oper:'bw', text:"za훾챠n찼 s"},{ oper:'bn', text:"neza훾챠n찼 s"},{ oper:'in', text:"je v"},{ oper:'ni', text:"nen챠 v"},{ oper:'ew', text:"kon훾챠 s"},{ oper:'en', text:"nekon훾챠 s"},{ oper:'cn', text:"obahuje"},{ oper:'nc', text:"neobsahuje"}],
